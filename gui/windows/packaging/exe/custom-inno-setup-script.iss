...
begin
  Page := CreateInputOptionPage(
         wpWelcome,
        '   Allow DLL injection',
        ' Project Ocean needs to inject DLLs into Fortnite to create the game server',
        'Selecting the option below will add Project Ocean to the Windows Exclusions list. ' +
